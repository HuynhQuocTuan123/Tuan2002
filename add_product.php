				...
				if($pic['size']<=614400){
					...
					if(pg_num_rows($result)==0)
					{
						...
						$sqlstring="INSERT INTO product(
							product_id, product_name, price, smalldesc, detaildesc, pro_qty, pro_image, cat_id, branch_id)
							VALUES('$id','$proname', $price,'$short','$detail',$qty,'$filePic','$category', '$branchlist')";
